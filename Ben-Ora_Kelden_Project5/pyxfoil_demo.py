...
def pyxfoil_demo(airfoil, Re1, Re2, alfas, plot):
    ...
    polar = pyxfoil.ReadXfoilPolar(f'Data/naca{foil}/naca{foil}_polar_Re0.00e+00a5.00.dat')
    ...
    viscpolar = pyxfoil.ReadXfoilPolar(f'Data/naca{foil}/naca{foil}_polar_Re{Re2:.2e}a5.00.dat')
